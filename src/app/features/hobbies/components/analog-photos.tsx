...
interface Photo {
  ...
  film: string;
  location: string;
  /** Filter group for the photography section (country/region or "Misc 😻") */
  filterGroup: string;
  src: string;
  w: number;
  h: number;
...
// Filter list: All, then places; Misc 😻 at the end.
const LOCATIONS = [
  "All",
  "Portugal",
  "Ireland",
...
const SEED_PHOTOS: Omit<Photo, "x" | "y" | "rotate">[] = [
  { id: 1, label: "Lisbon, 2023", film: "Kodak Portra 400", location: "Lisbon", filterGroup: "Portugal", src: "https://picsum.photos/seed/analog1/400/540", w: 220, h: 300 },
  { id: 2, label: "Tokyo, 2022", film: "Fuji Superia 200", location: "Tokyo", filterGroup: "Misc 😻", src: "https://picsum.photos/seed/analog2/540/360", w: 300, h: 200 },
  { id: 3, label: "Porto, 2024", film: "Ilford HP5", location: "Porto", filterGroup: "Portugal", src: "https://picsum.photos/seed/analog3/400/540", w: 220, h: 300 },
  { id: 4, label: "Berlin, 2023", film: "Kodak Gold 200", location: "Berlin", filterGroup: "Misc 😻", src: "https://picsum.photos/seed/analog4/400/400", w: 240, h: 240 },
  { id: 5, label: "Kyoto, 2022", film: "Kodak Portra 800", location: "Kyoto", filterGroup: "Misc 😻", src: "https://picsum.photos/seed/analog5/400/540", w: 220, h: 300 },
  { id: 6, label: "Alentejo, 2024", film: "Cinestill 800T", location: "Alentejo", filterGroup: "Portugal", src: "https://picsum.photos/seed/analog6/540/360", w: 300, h: 200 },
  { id: 7, label: "Amsterdam, 2023", film: "Fuji Pro 400H", location: "Amsterdam", filterGroup: "Misc 😻", src: "https://picsum.photos/seed/analog7/400/400", w: 240, h: 240 },
  { id: 8, label: "Sintra, 2024", film: "Ilford Delta 3200", location: "Sintra", filterGroup: "Portugal", src: "https://picsum.photos/seed/analog8/400/540", w: 220, h: 300 },
];
